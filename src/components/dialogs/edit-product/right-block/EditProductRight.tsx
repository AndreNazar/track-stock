  ...
  return (
    <div className="dialog__right">
      <div className="right__content">
        ...
        <div className="right__content-field-m"><Field heading="Цена доставки" placeholder="10" value={currentInfoEditor.priceDelivery} setValue={(e: string) => dispatch(changeCurrentInfoEditor({key: eBrandKeys.priceDelivery, value: e}))} /></div>
