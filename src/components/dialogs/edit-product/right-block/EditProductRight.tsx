  ...
  return (
    <div className="dialog__right">
      <div className="right__content">
        ...
        <div className="right__content-field-m right__content-price"><Field heading="Цена покупки" placeholder="10" value={currentInfoEditor.priceBuy} setValue={(e: string) => dispatch(changeCurrentInfoEditor({key: eBrandKeys.priceBuy, value: e}))} /></div>
        <div className="right__content-field-m right__content-price"><Field heading="Цена продажи" placeholder="10" value={currentInfoEditor.priceSale} setValue={(e: string) => dispatch(changeCurrentInfoEditor({key: eBrandKeys.priceSale, value: e}))} /></div>
        ...
        <div className="right__content-field-m right__content-city"><Field heading="Город" placeholder="Москва" value={currentInfoEditor.city} setValue={(e: string) => dispatch(changeCurrentInfoEditor({key: eBrandKeys.city, value: e}))} /></div>
        <div className="right__content-field-m right__content-place"><Field heading="Место сделки" placeholder="м. Белорусская" value={currentInfoEditor.placeOfTransaction} setValue={(e: string) => dispatch(changeCurrentInfoEditor({key: eBrandKeys.placeOfTransaction, value: e}))} /></div>
